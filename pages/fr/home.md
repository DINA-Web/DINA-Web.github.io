...
<div class="mt-5 mb-5">
    <div class="bg-success text-white p-2 home-lead mb-5">DINA's unique, "samplistic" design model traces complete object histories and preserves links to derivatives and related material​.</div>
    <div style="max-width:1200px;margin:0px auto;">
        <img width="100%" alt="Samplistic Model" src="{{ '/assets/theme/images/model.png' | relative_url }}" class="img-fluid">
    </div>
</div>

<div class="mt-5 mb-5">
    <div class="bg-success text-white p-2 home-lead mb-5">DINA is standards-compliant from metadata to material samples to their derived data products such as DNA sequences and multimedia.</div>
    <div style="max-width:1200px;margin:0px auto;">
...
<div class="mt-5" style="padding:56.25% 0 0 0;position:relative;">
    <div style="max-width:1200px;margin:0px auto;">
        <iframe src="https://player.vimeo.com/video/1001642789?h=391d411fab" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
